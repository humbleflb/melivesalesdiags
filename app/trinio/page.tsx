...
export const metadata: Metadata = {
  title: "Diagnóstico Trinio — Melive",
  description:
    "Mapa de conversão da Trinio: jornadas mais claras para oportunidades comerciais qualificadas.",
};

export default function TrinioPage() {
  return (
    <main>
      <MeliveIntro
        clientName="Trinio"
        bridgeId="diagnostico-trinio"
        skipToLabel="Ir ao diagnóstico Trinio"
        bridgeLead="A partir daqui, a leitura externa do site da Trinio — hipóteses, oportunidades e um piloto recomendado para gerar oportunidades comerciais mais qualificadas."
      />
      ...
      <SiteFooter caption="Diagnóstico preliminar da jornada de conversão • Trinio • Agosto de 2026" />
    </main>
  );
}
