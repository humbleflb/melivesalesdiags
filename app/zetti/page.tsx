...
export default function ZettiPage() {
  return (
    <main>
      <MeliveIntro
        clientName="Zetti"
        bridgeId="diagnostico-zetti"
        skipToLabel="Ir ao diagnóstico Zetti"
        bridgeLead="A partir daqui, a leitura externa do site da Zetti — hipóteses, oportunidades e um piloto recomendado para gerar demonstrações mais qualificadas."
      />
      ...
      <section className="next-section" id="proximos-passos">
        ...
        <div className="next-copy">
          ...
          <div className="hero-actions next-actions">
            ...
            <a className="button dark" href="/zetti/proposta">
      ...
      <SiteFooter caption="Diagnóstico preliminar da jornada de conversão • Zetti • Agosto de 2026" />
    </main>
  );
}
